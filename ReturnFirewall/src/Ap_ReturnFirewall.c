 ...
 *     Workspace:  C:/SynergyWorkspace/WorkingProjects/ReturnFirewall-gzkys7/ReturnFirewall/autosar
 *     SW-C Type:  Ap_ReturnFirewall
 *  Generated at:  Thu Jan 15 14:10:18 2015
 *
 ...
 * 01/14/15	 10      SB        Updated Rates and States Execution												 12905
 */
/**********************************************************************************************************************
...
STATIC volatile VAR(float32, DAMPINGFIREWALL_VAR) UprBound_MtrNm_D_f32;/* PRQA S 3218 */
STATIC volatile VAR(float32, DAMPINGFIREWALL_VAR) LwrBound_MtrNm_D_f32;/* PRQA S 3218 */
#define RETURNFIREWALL_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define RETURNFIREWALL_START_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h" /* PRQA S 5087 */
STATIC volatile VAR(boolean, DAMPINGFIREWALL_VAR) OverBound_Cnt_D_lgc;/* PRQA S 3218 */
